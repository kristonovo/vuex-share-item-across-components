...
var _Display = require('./Display.vue');

var _Display2 = _interopRequireDefault(_Display);

var _Increment = require('./Increment.vue');
...
exports.default = {
    ...
    vuex: {
        actions: {
            setInvitations: _actions.setInvitations
        },
        getters: {
            invitations: _getters.invitations
        }
    },
    ready: function ready() {
        this.setInvitations(this.invis);
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "D:\\xampp\\htdocs\\vuex\\resources\\assets\\js\\Components\\App.vue"
  if (!module.hot.data) {
...
},{"../vuex/actions":11,"../vuex/getters":12,"./Display.vue":6,"./Increment.vue":7,"vue":3,"vue-hot-reload-api":2}],6:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <h3>Invitations: {{ invitations }}</h3>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\xampp\\htdocs\\vuex\\resources\\assets\\js\\Components\\Display.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../Vuex/getters":8,"vue":3,"vue-hot-reload-api":2}],7:[function(require,module,exports){
'use strict';
...
exports.default = {
    vuex: {
        actions: {
            increment: _actions.incrementInvitations
        },
        getters: {
            invitations: _getters.invitations
        }
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <button @click=\"increment(1)\">Increment +1</button>\n    <p v-text=\"invitations\"></p>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\xampp\\htdocs\\vuex\\resources\\assets\\js\\Components\\Increment.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../vuex/actions":11,"../vuex/getters":12,"vue":3,"vue-hot-reload-api":2}],8:[function(require,module,exports){
"use strict";
...
var mutations = {
    ...
    SET_INVITATIONS: function SET_INVITATIONS(state, value) {
...
},{"vue":3,"vuex":4}],10:[function(require,module,exports){
'use strict';
...
},{"./Components/App.vue":5,"./Components/Display.vue":6,"./Components/Increment.vue":7,"./Vuex/store":9,"vue":3}],11:[function(require,module,exports){
'use strict';
...
var setInvitations = exports.setInvitations = makeAction('SET_INVITATIONS');
var incrementInvitations = exports.incrementInvitations = makeAction('INCREMENT');
